...
const RegisterPage = () => {
    ...
    const checkUsername = async () => {
        ...
        try {
            await axios.get(
                `http://192.168.0.80:8080/api/auth/check-username?username=${form.username}`
            );
    ...
    const sendCode = async () => {
        ...
        try {
            await axios.post("http://192.168.0.80:8080/api/auth/send-code", null, {
    ...
    const verifyCode = async () => {
        ...
        try {
            const res = await axios.post(
                "http://192.168.0.80:8080/api/auth/verify-code",
                null,
    ...
    const handleSubmit = async (e) => {
        ...
        try {
            await axios.post("http://192.168.0.80:8080/api/auth/register", form);
